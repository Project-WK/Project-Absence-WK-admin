        ...
        <div class="relative bg-white rounded-2xl shadow-xl border border-slate-200">
            ...
            <form id="edit-project-form" method="POST">
                ...
                <div class="flex items-center p-6 space-x-2 border-t border-slate-100 rounded-b bg-slate-50">
                    <button type="submit" class="text-white bg-amber-500 hover:bg-amber-600 focus:ring-4 focus:outline-none focus:ring-amber-300 font-medium rounded-xl text-sm px-5 py-2.5 text-center shadow-sm">Update Project</button>
