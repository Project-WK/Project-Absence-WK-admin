            ...
            <div class="flex-1 md:flex md:justify-between md:items-center">
                <div>
                    ...
                    <div class="mt-1 text-sm">
                        Terdapat <span class="font-bold">{{ $stats['pending_verifications'] }} karyawan baru</span> yang menunggu persetujuan.
                    </div>
                </div>
                <a href="{{ route('employees.index') }}" class="mt-3 md:mt-0 ml-auto whitespace-nowrap text-white bg-amber-600 hover:bg-amber-700 focus:ring-4 focus:ring-amber-300 font-medium rounded-lg text-xs px-4 py-2 inline-flex items-center transition shadow-sm">
                    Review Sekarang <i class="fa-solid fa-arrow-right ml-2"></i>
                </a>
            </div>
        </div>
    @endif
        ...
        <div class="lg:col-span-2 space-y-8">
            ...
            <div>
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    ...
                    <a href="{{ route('employees.index') }}" class="group flex flex-col items-center justify-center p-5 bg-white rounded-2xl shadow-sm border-2 border-dashed border-slate-200 hover:border-indigo-400 hover:bg-indigo-50/50 transition cursor-pointer">
                    ...
                    <a href="#" class="group flex flex-col items-center justify-center p-5 bg-white rounded-2xl shadow-sm border-2 border-dashed border-slate-200 hover:border-blue-400 hover:bg-blue-50/50 transition cursor-pointer">
                    ...
                    <a href="#" class="group flex flex-col items-center justify-center p-5 bg-white rounded-2xl shadow-sm border-2 border-dashed border-slate-200 hover:border-emerald-400 hover:bg-emerald-50/50 transition cursor-pointer">
                     ...
                     <a href="#" class="group flex flex-col items-center justify-center p-5 bg-white rounded-2xl shadow-sm border-2 border-dashed border-slate-200 hover:border-purple-400 hover:bg-purple-50/50 transition cursor-pointer">
        ...
        <div class="space-y-8">
                ...
                <div class="space-y-3">
                    <div class="flex items-center gap-4 p-3 bg-slate-50 rounded-xl border border-slate-100">
                        <div class="flex-col items-center justify-center text-center w-10 shrink-0">
                            <span class="text-[10px] font-bold text-rose-500 uppercase block">DES</span>
                            <span class="text-xl font-bold text-slate-800 block leading-none">25</span>
                        </div>
                        <div class="h-8 w-px bg-slate-200"></div>
                        <div>
                            <h4 class="text-sm font-bold text-slate-800">Hari Raya Natal</h4>
                            <p class="text-xs text-slate-500">Libur Nasional</p>
                        </div>
                    </div>

                    <div class="flex items-center gap-4 p-3 bg-white rounded-xl border border-slate-100">
                        <div class="flex-col items-center justify-center text-center w-10 shrink-0">
                            <span class="text-[10px] font-bold text-indigo-500 uppercase block">JAN</span>
                            <span class="text-xl font-bold text-slate-800 block leading-none">01</span>
                        </div>
                        <div class="h-8 w-px bg-slate-200"></div>
                        <div>
                            <h4 class="text-sm font-bold text-slate-800">Tahun Baru 2026</h4>
                            <p class="text-xs text-slate-500">Libur Nasional</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                <div class="px-6 py-5 border-b border-slate-100 flex justify-between items-center">
                    ...
                    <a href="#" class="text-sm font-medium text-indigo-600 hover:text-indigo-700 hover:underline">Lihat Semua</a>
                </div>
                        ...
                        <tbody class="divide-y divide-slate-100">
                            <tr class="bg-white hover:bg-slate-50 transition">
                                <td class="px-6 py-4 font-medium text-slate-900 flex items-center">
                                    <div class="w-8 h-8 rounded-full bg-indigo-100 text-indigo-600 flex items-center justify-center text-xs font-bold mr-3">BS</div>
                                    Budi S.
                                </td>
                                <td class="px-6 py-4">
                             ...
                             <tr class="bg-white hover:bg-slate-50 transition">
                                <td class="px-6 py-4 font-medium text-slate-900 flex items-center">
                                    <div class="w-8 h-8 rounded-full bg-rose-100 text-rose-600 flex items-center justify-center text-xs font-bold mr-3">SA</div>
                                    Siti A.
                                </td>
                                <td class="px-6 py-4">
